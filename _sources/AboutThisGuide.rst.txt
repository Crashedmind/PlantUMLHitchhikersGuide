...
To enable this, I suggested the *keyword arguments* and Arnaud produced a release to play with next day - and this became part of an official release:
...
Sphinx and PlantUML (running in Docker) are the primary tools used for this guide. 
