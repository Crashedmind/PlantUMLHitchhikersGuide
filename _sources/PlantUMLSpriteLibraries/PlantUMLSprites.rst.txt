...
3. a new bare-minimum macro will be created that requires only 1
   parameter !define Batch(e\_alias)
4. a new macro will be added to allow scaling the icon size
...
different i.e. not very user friendly to the use who just wants to use
